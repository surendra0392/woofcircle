...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('trainer_profile_specialization', function (Blueprint $table) {
            $table->id();
            $table->foreignId('directory_profile_id')->constrained('directory_profiles')->cascadeOnDelete();
            $table->foreignId('trainer_specialization_id')->constrained()->cascadeOnDelete();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('trainer_profile_specialization');
