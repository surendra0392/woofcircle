...
interface PageProps {
    ...
    petShops: PaginatedResponse<PetShop>;
    states: State[];
...
export default function PetShopsListing({
    petShops,
    states,
    filters,
    ...
    const resetFilters = () => {
        ...
        router.get(route('directory.pet-shops'), { view: view });
    };
    const fadeInUp = {
                        ...
                        >
                            <div className="space-y-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-woof-gold text-xs font-black tracking-[0.4em] uppercase">Curated Collections</span>
                                </div>

                                <h1 className="text-4xl leading-16 font-bold tracking-wider text-woof-charcoal uppercase">
                                    Elite <span className="text-woof-gold">Pet Shops.</span>
                                </h1>
                            </div>

                            <p className="text-sm text-woof-charcoal/60 max-w-lg tracking-wider leading-relaxed font-medium">
                                Exceptional supplies for the modern canine. Discover India's most curated pet shops and premium boutiques.
                            </p>
                        </div>
                    ...
                    {petShops.data.length === 0 ? (
                        <div className="border-[#e8ded1] bg-[#fcfbf9] space-y-6 rounded-3xl border p-12 sm:p-20 text-center shadow-xs">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-woof-charcoal/60 mx-auto max-w-sm text-sm leading-relaxed font-normal">
                                    We couldn't find any pet shops in this region. Try adjusting your filters.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div className="lg:col-span-8 space-y-6">
                                <div className="grid grid-cols-1 gap-6">
                                    {petShops.data.map((shop, idx) => (
                                        <DirectoryCard key={shop.id} idx={idx} item={shop} type="pet-shop" view="list" />
                                    ))}
                                </div>

                                {petShops.links && petShops.links.length > 3 && (
                                    <div className="pt-8">
                        ...
                        <div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                {petShops.data.map((shop, idx) => (
                                    <DirectoryCard key={shop.id} idx={idx} item={shop} type="pet-shop" view="grid" />
                                ))}
                            </div>
