...
interface PageProps {
    ...
    welfares: PaginatedResponse<Welfare>;
    states: State[];
...
export default function WelfareListing({
    welfares,
    states,
    filters,
    ...
    const resetFilters = () => {
        ...
        router.get(route('directory.welfare'), { view: view });
    };
    const fadeInUp = {
                        ...
                        >
                            <div className="space-y-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-woof-gold text-xs font-black tracking-[0.4em] uppercase">Compassionate Guardians</span>
                                </div>

                                <h1 className="text-4xl leading-16 font-bold tracking-wider text-woof-charcoal uppercase">
                                    Pet <span className="text-woof-gold">Welfare.</span>
                                </h1>
                            </div>

                            <p className="text-sm text-woof-charcoal/60 max-w-lg tracking-wider leading-relaxed font-medium">
                                Supporting those who protect the voiceless. Connect with India's most dedicated rescue and welfare organizations.
                            </p>
                        </div>
                        ...
                        >
                            <div className="border-[#e8ded1] focus-within:border-woof-gold/60 focus-within:shadow-md bg-white rounded-3xl sm:rounded-full p-2 pl-6 flex w-full items-center gap-4 border shadow-xs transition-all duration-300 sm:w-[620px]">
                                <div className="text-woof-charcoal/70 flex flex-1 items-center gap-3">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search organization name or city..."
                                    ...
                                    >
                                        ...
                                        <div className="cursor-pointer space-y-0.5">
                                            ...
                                            <p className="text-woof-charcoal/50 text-[10px] font-normal">
                                                Show verified welfare shelters
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="border-[#e8ded1] bg-[#fcfbf9] space-y-6 rounded-3xl border p-12 sm:p-20 text-center shadow-xs">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-woof-charcoal/60 mx-auto max-w-sm text-sm leading-relaxed font-normal">
                                    We couldn't find any welfare organizations in this region. Try adjusting your filters.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div className="lg:col-span-8 space-y-6">
                                <div className="grid grid-cols-1 gap-6">
                                    {welfares.data.map((welfare, idx) => (
                                        <DirectoryCard
                                            key={welfare.id}
                                            idx={idx}
                                            item={welfare as unknown as DirectoryItem}
                                            type="welfare"
                                            view="list"
                                        />
                                    ))}
                                ...
                                {welfares.links && welfares.links.length > 3 && (
                                    <div className="pt-8">
                                        <Pagination links={welfares.links} />
                                    </div>
                                )}
                            </div>
