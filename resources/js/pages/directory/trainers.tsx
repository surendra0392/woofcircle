...
export default function TrainersListing({
    trainers,
    states,
    filters,
    ...
    const resetFilters = () => {
        ...
        router.get(route('directory.trainers'), { view: view });
    };
    const fadeInUp = {
                        ...
                        >
                            <div className="space-y-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-woof-gold text-xs font-black tracking-[0.4em] uppercase">Distinguished Education</span>
                                </div>

                                <h1 className="text-4xl leading-16 font-bold tracking-wider text-woof-charcoal uppercase">
                                    Expert <span className="text-woof-gold">Trainers.</span>
                                </h1>
                            </div>

                            <p className="text-sm text-woof-charcoal/60 max-w-lg tracking-wider leading-relaxed font-medium">
                                Refine your canine's potential with India's most distinguished trainers. From obedience to specialized behavioral
                                coaching.
                            </p>
                        </div>
                        ...
                        >
                            <div className="border-[#e8ded1] focus-within:border-woof-gold/60 focus-within:shadow-md bg-white rounded-3xl sm:rounded-full p-2 pl-6 flex w-full items-center gap-4 border shadow-xs transition-all duration-300 sm:w-[620px]">
                                <div className="text-woof-charcoal/70 flex flex-1 items-center gap-3">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search trainer name, kennel, or city..."
                    ...
                    {trainers.data.length === 0 ? (
                        <div className="border-[#e8ded1] bg-[#fcfbf9] space-y-6 rounded-3xl border p-12 sm:p-20 text-center shadow-xs">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-woof-charcoal/60 mx-auto max-w-sm text-sm leading-relaxed font-normal">
                                    We couldn't find any professional training partners in this region.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div className="lg:col-span-8 space-y-6">
                                <div className="grid grid-cols-1 gap-6">
                                    {trainers.data.map((trainer, idx) => (
                                        <DirectoryCard key={trainer.id} idx={idx} item={trainer} type="trainer" view="list" />
                                    ))}
                                </div>
                        ...
                        <div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                {trainers.data.map((trainer, idx) => (
                                    <DirectoryCard key={trainer.id} idx={idx} item={trainer} type="trainer" view="grid" />
                                ))}
                            </div>
