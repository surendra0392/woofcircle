...
import CuratedListingSidebar, { FeaturedAdoption, FeaturedLitter, FeaturedStud } from '@/components/public/curated-listing-sidebar';
...
interface PageProps {
    ...
    breeders: PaginatedResponse<BreederProfile>;
    states: State[];
...
export default function BreedersIndex({
    breeders,
    states,
    filters,
    ...
    const [filterData, setFilterData] = useState({
        ...
        is_verified: filters.is_verified?.toString() || 'all',
    ...
    const resetFilters = () => {
        setFilterData({ state_id: 'all', city_id: 'all', is_verified: 'all', search: '', orderby: 'featured', view: view });
        router.get(route('marketplace.breeders.index'), { view: view });
    };
    return (
        <PublicLayout>
                        ...
                        >
                            <div className="space-y-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-woof-gold text-xs font-black tracking-[0.4em] uppercase">India's Premium Kennels</span>
                                </div>

                                <h1 className="text-4xl leading-16 font-bold tracking-wider text-woof-charcoal uppercase">
                                    Verified <span className="text-woof-gold">Breeders.</span>
                                </h1>
                            </div>

                            <p className="text-sm text-woof-charcoal/60 max-w-lg tracking-wider leading-relaxed font-medium">
                                Connect with the country's most ethical and responsible dog breeders. Every kennel is pre-screened for quality,
                                health, and welfare excellence.
                            </p>
                        </div>
                        ...
                        >
                            <div className="border-[#e8ded1] focus-within:border-woof-gold/60 focus-within:shadow-md bg-white rounded-3xl sm:rounded-full p-2 pl-6 flex w-full items-center gap-4 border shadow-xs transition-all duration-300 sm:w-[620px]">
                                <div className="text-woof-charcoal/70 flex flex-1 items-center gap-3">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search by kennel name, breeder, or location..."
                            ...
                            <div className="grid w-full grid-cols-1 items-end gap-6 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div className="group space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(v) => setFilterData({ ...filterData, is_verified: v })}
                                    >
                                        <SelectTrigger className="border-[#e8ded1] rounded-2xl bg-[#fcfbf9] text-xs font-medium">
                                        ...
                                        <SelectContent className="border-[#e8ded1] rounded-2xl bg-white p-1.5 shadow-xl">
                                            ...
                                            <SelectItem value="1" className="rounded-xl py-2 text-xs font-medium">
                                                Verified Only
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
                    ...
                    {breeders.data.length === 0 ? (
                        <div className="border-[#e8ded1] bg-[#fcfbf9] space-y-6 rounded-3xl border p-12 sm:p-20 text-center shadow-xs">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-woof-charcoal/60 mx-auto max-w-sm text-sm leading-relaxed font-normal">
                                    We couldn't find any breeders matching your search criteria. Please try another location.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div className="lg:col-span-8 space-y-6">
                                    ...
                                    {breeders.data.map((breeder, idx) => (
                                        <DirectoryCard
                                            ...
                                            item={
                                                {
                                                    ...breeder,
                                                    name: breeder.kennel_name || breeder.name || 'Verified Breeder',
                                                    description: breeder.description || 'Premium ethical breeder.',
                                ...
                                {breeders.links && breeders.links.length > 3 && (
                                    <div className="pt-8">
