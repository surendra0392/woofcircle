...
export default function BreederDashboard({ profile, analytics }: SharedData & Props) {
    const hasProfile = !!profile;

    return (
        <DashboardLayout
            breadcrumbs={breadcrumbs}
            title="Breeder Console"
            subtitle="Analytics, kennel overview, and litters management"
            actions={
                <Link
                ...
                >
                    <Users className="h-4 w-4" /> Manage Profile
                </Link>
            }
        >
            <Head title="Breeder Console" />
            ...
            <div className="mx-auto max-w-7xl space-y-8 pb-16">
                ...
                {!hasProfile && (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border border-amber-200 bg-amber-50 p-6 shadow-xs">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-amber-900">Kennel Profile Required</h4>
                                <p className="text-xs text-amber-700/90 mt-0.5">
                                    Create your breeder kennel profile to showcase verified litters and pedigree credentials to the community.
                                </p>
                            </div>
                        </div>
                        <Link
                ...
                {hasProfile && !analytics.is_active && (
                    <div className="flex items-start sm:items-center gap-4 rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-xs">
                        ...
                        <div>
                            <h4 className="text-sm font-bold text-rose-900">Kennel Profile Pending Review</h4>
                            <p className="text-xs text-rose-700/90 mt-0.5">
                                Your kennel is currently hidden from public directory search while our verification team validates your paperwork.
                            </p>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal truncate text-xl font-bold">
                            {hasProfile ? (analytics.is_verified ? 'Verified Breeder' : 'Registered') : '—'}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Gallery Images</p>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-woof-charcoal/40 uppercase tracking-wider">Litters</span>
                        </div>
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Litter Management</p>
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    {/* Left Column: Analytics & Litters Overview */}
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Kennel Analytics</h2>
                                        <p className="text-xs text-woof-charcoal/60">Track your kennel's marketplace reach and favorites</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Kennel Saves</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    <Star className="mx-auto mb-2 h-5 w-5 text-amber-500" />
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Direct Inquiries</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Litters Overview</h2>
                                        <p className="text-xs text-woof-charcoal/60">Manage your champion litters and puppy listings</p>
                                    </div>
                                </div>
                                <Link
                            ...
                            <div className="rounded-3xl border border-dashed border-[#e8ded1] bg-[#fcfbf9] p-8 text-center">
                                ...
                                <h3 className="text-base font-bold text-woof-charcoal mb-1">Registered Litters</h3>
                                <p className="mx-auto mb-6 max-w-md text-xs text-woof-charcoal/60">
                                    List your registered litters with KCI certifications, Sire/Dam pedigrees, microchip IDs, and health testing.
                                </p>
                                <Link
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3 border-b border-[#e8ded1] pb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-woof-charcoal/50">Manage kennel operations</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {profile && (
                                    <Link
                                        href={route('marketplace.breeders.show', { slug: profile.slug || profile.id })}
                                        className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                    >
                        ...
                        <div className="rounded-3xl border border-[#e8ded1] bg-white p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-woof-charcoal">Breeder Partnership</h4>
