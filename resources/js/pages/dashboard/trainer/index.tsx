...
export default function TrainerDashboard({ profile, analytics }: SharedData & Props) {
    ...
    return (
        <DashboardLayout
            ...
            subtitle="Analytics, class management, and training programs"
            actions={
                <Link
                ...
                >
                    <GraduationCap className="h-4 w-4" /> Manage Profile
                </Link>
            }
        >
            <Head title="Trainer Console" />
            ...
            <div className="mx-auto max-w-7xl space-y-8 pb-16">
                ...
                {!hasProfile && (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border border-amber-200 bg-amber-50 p-6 shadow-xs">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-amber-900">Trainer Profile Required</h4>
                                <p className="text-xs text-amber-700/90 mt-0.5">
                                    Create your canine trainer profile to showcase your behavioral methodologies and receive student bookings.
                                </p>
                            </div>
                        </div>
                        <Link
                    ...
                    <div className="flex items-start sm:items-center gap-4 rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-xs">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-rose-700/90 mt-0.5">
                                Your trainer profile is currently hidden while our compliance team verifies your canine behavioral certifications.
                            </p>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Profile Status</p>
                        <p className="text-woof-charcoal truncate text-xl font-bold">
                            {hasProfile ? (analytics.is_verified ? 'Verified Trainer' : 'Registered') : '—'}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-woof-charcoal/40 uppercase tracking-wider">Programs</span>
                        </div>
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Training Inquiries</p>
                        <p className="text-woof-charcoal text-xl font-bold">Active Hub</p>
                    </div>
                </div>

                {/* Main Grid */}
                <div className="grid gap-8 lg:grid-cols-3">
                    {/* Left Column: Analytics & Training Programs */}
                    <div className="space-y-6 lg:col-span-2">
                        {/* Trainer Engagement Overview */}
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Trainer Analytics</h2>
                                        <p className="text-xs text-woof-charcoal/60">Track impressions, student saves, and direct consultations</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Profile Views</p>
                                ...
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Trainer Saves</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Programs & Specializations</h2>
                                        <p className="text-xs text-woof-charcoal/60">Manage your agility, obedience, and behavioral training programs</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-3xl border border-dashed border-[#e8ded1] bg-[#fcfbf9] p-8 text-center">
                                ...
                                <h3 className="text-base font-bold text-woof-charcoal mb-1">Specializations & Certifications</h3>
                                <p className="mx-auto mb-6 max-w-md text-xs text-woof-charcoal/60">
                                    Keep your pricing, experience years, certifications, and training methodology updated on your profile.
                                </p>
                                <Link
                                    href="/dashboard/trainer/profile"
                                ...
                                >
                                    <Plus className="h-4 w-4" /> Edit Programs & Bio
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3 border-b border-[#e8ded1] pb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-woof-charcoal/50">Manage training services</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {profile && (
                                    <Link
                                        href={route('directory.trainers.show', { slug: profile.slug || profile.id })}
                                        className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                    >
                                ...
                                <Link
                                    ...
                                    className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                >
                                    <GraduationCap className="h-4 w-4 text-woof-gold transition-transform group-hover:scale-110" />
                                    <span className="flex-1 text-xs font-bold text-woof-charcoal">
                                        Browse Trainer Directory
                                    </span>
                                    <ArrowUpRight className="h-3.5 w-3.5 text-woof-charcoal/40 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                                </Link>
                            </div>
                        ...
                        <div className="rounded-3xl border border-[#e8ded1] bg-white p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-woof-charcoal">Certified Trainer Partner</h4>
