...
export default function CreateMedicalRecord({ pet, recordTypes, vets }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('pets.medical-records.store', pet.id), {
            onSuccess: () => {
                toast.success('Medical record logged successfully.');
            }
        });
    };
    ...
    return (
        <DashboardLayout
            ...
            subtitle={`Record clinical diagnosis or surgical notes for ${pet.name}`}
            actions={
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        type="submit"
                        form="create-medical-record-form"
                        variant="custom"
                        disabled={processing}
        ...
        >
            <Head title={`Log Medical Record - ${pet.name}`} />

            <div className="pb-16 max-w-4xl mx-auto space-y-6">
                <form id="create-medical-record-form" onSubmit={handleSubmit} className="space-y-6">
