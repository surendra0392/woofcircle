...
export default function VetDashboard({ profile, analytics }: SharedData & Props) {
    const hasProfile = !!profile;

    return (
        <DashboardLayout
            breadcrumbs={breadcrumbs}
            title="Veterinary Console"
            subtitle="Analytics, clinic management, and medical consultations"
            actions={
                <Link
                    href="/vet/profile"
                ...
                >
                    <Stethoscope className="h-4 w-4" /> Manage Clinic
                </Link>
            }
        >
            <Head title="Veterinary Console" />
            ...
            <div className="mx-auto max-w-7xl space-y-8 pb-16">
                ...
                {!hasProfile && (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border border-amber-200 bg-amber-50 p-6 shadow-xs">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-amber-900">Clinic Profile Required</h4>
                                <p className="text-xs text-amber-700/90 mt-0.5">
                                    Create your veterinary clinic profile to list medical services and receive appointments from pet owners.
                                </p>
                            </div>
                        </div>
                        <Link
                    ...
                    <div className="flex items-start sm:items-center gap-4 rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-xs">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-rose-700/90 mt-0.5">
                                Your veterinary profile is hidden while our medical compliance team validates your veterinary council credentials.
                            </p>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Clinic Status</p>
                        <p className="text-woof-charcoal truncate text-xl font-bold">
                            {hasProfile ? (analytics.is_verified ? 'Verified Clinic' : 'Registered') : '—'}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-woof-charcoal/40 uppercase tracking-wider">Appointments</span>
                        </div>
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Consultation Hub</p>
                        <p className="text-woof-charcoal text-xl font-bold">Live</p>
                    </div>
                </div>

                {/* Main Grid */}
                <div className="grid gap-8 lg:grid-cols-3">
                    {/* Left Column: Analytics & Clinical Services */}
                    <div className="space-y-6 lg:col-span-2">
                        {/* Clinic Engagement Overview */}
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Clinic Analytics</h2>
                                        <p className="text-xs text-woof-charcoal/60">Track directory inquiries, client saves, and consultations</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Clinic Page Views</p>
                                ...
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Clinic Bookmarks</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    <Star className="mx-auto mb-2 h-5 w-5 text-amber-500" />
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Appointment Requests</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Clinical Services</h2>
                                        <p className="text-xs text-woof-charcoal/60">Highlight your surgery, diagnostics, and vaccination expertise</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-3xl border border-dashed border-[#e8ded1] bg-[#fcfbf9] p-8 text-center">
                                ...
                                <h3 className="text-base font-bold text-woof-charcoal mb-1">Directory Visibility</h3>
                                <p className="mx-auto mb-6 max-w-md text-xs text-woof-charcoal/60">
                                    Ensure your operating hours, emergency contact, diagnostic facilities, and services are fully documented for verified pet parents.
                                </p>
                                <Link
                                    href="/vet/profile"
                                ...
                                >
                                    <Plus className="h-4 w-4" /> Edit Services & Hours
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3 border-b border-[#e8ded1] pb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-woof-charcoal/50">Manage clinical practice</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {profile && (
                                    <Link
                                        href={route('directory.vets.show', { slug: profile.slug || profile.id })}
                                        className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                    >
                                ...
                                <Link
                                    ...
                                    className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                >
                                    <Stethoscope className="h-4 w-4 text-woof-gold transition-transform group-hover:scale-110" />
                                    <span className="flex-1 text-xs font-bold text-woof-charcoal">
                                        Browse Vet Directory
                                    </span>
                                    <ArrowUpRight className="h-3.5 w-3.5 text-woof-charcoal/40 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                                </Link>
                            </div>
                        ...
                        <div className="rounded-3xl border border-[#e8ded1] bg-white p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-woof-charcoal">Veterinary Partner</h4>
