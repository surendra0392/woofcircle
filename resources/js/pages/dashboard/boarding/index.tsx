...
export default function BoardingDashboard({ profile, analytics }: SharedData & Props) {
    ...
    return (
        <DashboardLayout
            ...
            subtitle="Analytics, capacity tracking, and booking schedules"
            actions={
                <Link
                ...
                >
                    <Home className="h-4 w-4" /> Manage Facility
                </Link>
            }
        >
            <Head title="Boarding Console" />
            ...
            <div className="mx-auto max-w-7xl space-y-8 pb-16">
                ...
                {!hasProfile && (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border border-amber-200 bg-amber-50 p-6 shadow-xs">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-amber-900">Boarding Profile Required</h4>
                                <p className="text-xs text-amber-700/90 mt-0.5">
                                    Create your boarding and daycare facility profile to showcase rooms, amenities, and receive reservation requests.
                                </p>
                            </div>
                        </div>
                        <Link
                    ...
                    <div className="flex items-start sm:items-center gap-4 rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-xs">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-rose-700/90 mt-0.5">
                                Your boarding facility profile is hidden while our team verifies your facility safety standards and licensing.
                            </p>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Facility Status</p>
                        <p className="text-woof-charcoal truncate text-xl font-bold">
                            {hasProfile ? (analytics.is_verified ? 'Verified Stay' : 'Registered') : '—'}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Facility Photos</p>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-woof-charcoal/40 uppercase tracking-wider">Boarding</span>
                        </div>
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Guest Stays</p>
                        <p className="text-woof-charcoal text-xl font-bold">Active Suite</p>
                    </div>
                </div>

                {/* Main Grid */}
                <div className="grid gap-8 lg:grid-cols-3">
                    {/* Left Column: Analytics & Facility Capacity */}
                    <div className="space-y-6 lg:col-span-2">
                        {/* Boarding Engagement Overview */}
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Boarding Analytics</h2>
                                        <p className="text-xs text-woof-charcoal/60">Track views, customer saves, and stay reservation requests</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Facility Views</p>
                                ...
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Facility Saves</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    <Star className="mx-auto mb-2 h-5 w-5 text-amber-500" />
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Stay Bookings</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Accommodations & Amenities</h2>
                                        <p className="text-xs text-woof-charcoal/60">Manage suite tiers, CCTV live feeds, play yards, and pricing</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-3xl border border-dashed border-[#e8ded1] bg-[#fcfbf9] p-8 text-center">
                                ...
                                <h3 className="text-base font-bold text-woof-charcoal mb-1">Facility Presentation</h3>
                                <p className="mx-auto mb-6 max-w-md text-xs text-woof-charcoal/60">
                                    Maintain updated photos of sleeping kennels, outdoor play yards, hygiene protocols, and daily rates.
                                </p>
                                <Link
                                    href="/boarding/profile"
                                ...
                                >
                                    <Plus className="h-4 w-4" /> Edit Rates & Amenities
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3 border-b border-[#e8ded1] pb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-woof-charcoal/50">Manage facility operations</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {profile && (
                                    <Link
                                        href={route('directory.boarding.show', { slug: profile.slug || profile.id })}
                                        className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                    >
                                ...
                                <Link
                                    ...
                                    className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                >
                                    <Home className="h-4 w-4 text-woof-gold transition-transform group-hover:scale-110" />
                                    <span className="flex-1 text-xs font-bold text-woof-charcoal">
                                        Browse Boarding Directory
                                    </span>
                                    <ArrowUpRight className="h-3.5 w-3.5 text-woof-charcoal/40 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                                </Link>
                            </div>
                        ...
                        <div className="rounded-3xl border border-[#e8ded1] bg-white p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-woof-charcoal">Boarding Partner</h4>
