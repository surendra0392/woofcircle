...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Boutique Console', href: '/dashboard/pet-shop' },
];
...
export default function PetShopDashboard({ profile, analytics }: SharedData & Props) {
    ...
    return (
        <DashboardLayout
            ...
            subtitle="Analytics, retail inventory overview, and shop profile management"
            actions={
                <Link
                    href="/pet-shop/profile"
                ...
                >
                    <ShoppingBag className="h-4 w-4" /> Manage Boutique
                </Link>
            }
        >
            <Head title="Boutique Console" />
            ...
            <div className="mx-auto max-w-7xl space-y-8 pb-16">
                ...
                {!hasProfile && (
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-3xl border border-amber-200 bg-amber-50 p-6 shadow-xs">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-amber-900">Boutique Profile Required</h4>
                                <p className="text-xs text-amber-700/90 mt-0.5">
                                    Create your pet shop profile to showcase nutrition brands, accessories, and gear in the WoofCircle directory.
                                </p>
                            </div>
                        </div>
                        <Link
                    ...
                    <div className="flex items-start sm:items-center gap-4 rounded-3xl border border-rose-200 bg-rose-50 p-6 shadow-xs">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-rose-700/90 mt-0.5">
                                Your shop profile is hidden while our compliance team verifies your business registration.
                            </p>
                        </div>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Store Status</p>
                        <p className="text-woof-charcoal truncate text-xl font-bold">
                            {hasProfile ? (analytics.is_verified ? 'Verified Shop' : 'Registered') : '—'}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        ...
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Store Photos</p>
                    ...
                    <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs hover:shadow-md transition-all">
                        <div className="mb-3 flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-woof-charcoal/40 uppercase tracking-wider">Inventory</span>
                        </div>
                        <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Catalog Status</p>
                        <p className="text-woof-charcoal text-xl font-bold">Live Hub</p>
                    </div>
                </div>

                {/* Main Grid */}
                <div className="grid gap-8 lg:grid-cols-3">
                    {/* Left Column: Analytics & Retail Showcase */}
                    <div className="space-y-6 lg:col-span-2">
                        {/* Pet Shop Engagement Overview */}
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Store Analytics</h2>
                                        <p className="text-xs text-woof-charcoal/60">Track foot-traffic clicks, brand saves, and customer inquiries</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Shop Page Views</p>
                                ...
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    ...
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Shop Saves</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                                <div className="rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-4 text-center">
                                    <Star className="mx-auto mb-2 h-5 w-5 text-amber-500" />
                                    <p className="text-woof-charcoal/50 text-[10px] font-bold uppercase tracking-wider mb-1">Customer Inquiries</p>
                                    <p className="text-woof-charcoal text-2xl font-bold">—</p>
                                    <p className="text-woof-charcoal/40 text-[10px] mt-1">Collecting data</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 sm:p-8 shadow-xs space-y-6">
                            <div className="flex items-center justify-between border-b border-[#e8ded1] pb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-woof-charcoal">Featured Product Lines</h2>
                                        <p className="text-xs text-woof-charcoal/60">Highlight your specialized nutrition brands, toys, and grooming gear</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="rounded-3xl border border-dashed border-[#e8ded1] bg-[#fcfbf9] p-8 text-center">
                                ...
                                <h3 className="text-base font-bold text-woof-charcoal mb-1">Boutique Directory Presence</h3>
                                <p className="mx-auto mb-6 max-w-md text-xs text-woof-charcoal/60">
                                    Keep your retail storefront address, opening hours, WhatsApp inquiry number, and brand inventory fresh.
                                </p>
                                <Link
                                    href="/pet-shop/profile"
                                ...
                                >
                                    <Plus className="h-4 w-4" /> Edit Shop Details & Hours
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-3xl border border-[#e8ded1] p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3 border-b border-[#e8ded1] pb-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-woof-charcoal/50">Manage retail storefront</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {profile && (
                                    <Link
                                        href={route('directory.pet-shops.show', { slug: profile.slug || profile.id })}
                                        className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                    >
                                ...
                                <Link
                                    ...
                                    className="group flex items-center gap-3 rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] hover:bg-white hover:border-woof-gold p-3.5 transition-all shadow-2xs"
                                >
                                    <Store className="h-4 w-4 text-woof-gold transition-transform group-hover:scale-110" />
                                    <span className="flex-1 text-xs font-bold text-woof-charcoal">
                        ...
                        <div className="rounded-3xl border border-[#e8ded1] bg-white p-6 shadow-xs space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-woof-charcoal">Verified Retail Partner</h4>
                            ...
                            <div className="space-y-2.5">
                                ...
                                <div className="flex items-center justify-between rounded-2xl border border-[#e8ded1] bg-[#fcfbf9] p-3">
                                    ...
                                    <span className="text-xs font-bold text-woof-charcoal">{analytics.is_verified ? '9.8 / 10' : '—'}</span>
                                </div>
                            </div>
                        </div>
                    </div>
