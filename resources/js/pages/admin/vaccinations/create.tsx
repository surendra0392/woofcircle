...
import { ArrowLeft, Save, Info, Building2, Calendar, FileText, ShieldCheck } from 'lucide-react';

export default function VaccinationCreatePage({ pets = [], vets = [] }: any) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('admin.vaccinations.store'), {
            ...
            onError: () => {
                toast.error('Failed to register vaccination. Please check form validation errors.');
            }
        });
    };

    return (
        <AdminLayout title="Register Vaccination">
            <Head title="Register Vaccination - Admin" />
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-woof-charcoal">Register Vaccination</h2>
                    <p className="text-xs text-woof-charcoal/60">Log immunization date, vaccine brand, and booster schedule</p>
                </div>
            </div>
