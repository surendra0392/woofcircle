...
export default function AppointmentCreatePage({ pets = [], vets = [], appointmentTypes = [], statuses = [] }: PageProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('admin.appointments.store'), {
            ...
            onError: () => {
                toast.error('Failed to schedule appointment. Please check validation errors.');
            }
        });
    };

    return (
        <AdminLayout title="Add Appointment Schedule">
            <Head title="Schedule Appointment - Admin" />
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-woof-charcoal">New Schedule Entry</h2>
                    <p className="text-xs text-woof-charcoal/60">Book consultations, wellness visits, and clinical procedures</p>
                </div>
            </div>
