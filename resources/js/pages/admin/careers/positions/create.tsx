...
export default function PositionCreate() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.career-positions.store'), {
            onSuccess: () => {
    ...
    return (
        <AdminLayout title="Add Career Position">
            <Head title="Add Career Position - Admin" />
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold tracking-tight text-woof-charcoal">Add Career Position</h2>
                        <p className="text-xs text-woof-charcoal/60">Publish a new job opening to the public career board</p>
                    </div>
                </div>
