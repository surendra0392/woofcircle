...
export default function KBEdit({ article, categories, baseRoute }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route(`${baseRoute}.update`, article.id));
    };
        ...
        <div className="w-full">
            ...
            <div className="bg-white rounded-3xl border border-[#e8ded1] shadow-xs p-6 sm:p-8 max-w-4xl mx-auto">
                <div className="flex items-center gap-4 mb-6 pb-4 border-b border-[#e8ded1]">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-woof-charcoal">Edit Documentation Article</h1>
                        <p className="text-xs text-woof-charcoal/60 mt-0.5">Update standard operating procedure, protocol, or policy details.</p>
                    </div>
                </div>
